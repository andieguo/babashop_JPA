...
<frameset framespacing="0" border="0" rows="60,*,15" frameborder="0">
  ...
  <frameset cols="168,*">
    <frame name="menuframe" target="mainframe" src="<s:url action="/control/center/left"/>" scrolling="no" marginwidth="0" marginheight="0">
    <frame name="mainframe" scrolling="auto" noresize src="<s:url action="/control/center/right"/>" marginwidth="0" marginheight="0">
  </frameset>
  <frame name="menuframe" target="mainframe" src="<s:url action="/control/center/end"/>" scrolling="no" marginwidth="0" marginheight="0">
