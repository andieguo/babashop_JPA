...
<s:form action="edit" namespace="/control/productstyle" method="post" enctype="multipart/form-data" onsubmit="return checkfm(this)">
<s:hidden name="productstyleid"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="file" name="image" size="50"><br>
      <img src="<%=basePath %>${imagepath }" width="100">
      </td>
    </tr>
    <tr bgcolor="f5f5f5"> 
