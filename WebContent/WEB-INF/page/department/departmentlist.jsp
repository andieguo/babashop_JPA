...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="<html:rewrite action="/control/department/manage"/>?method=editDepartmentUI&departmentid=${entry.departmentid}">
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="<html:rewrite action="/control/department/manage"/>?method=delete&departmentid=${entry.departmentid}">删除</a></div></td>
	</tr>
</c:forEach>
    <!----------------------LOOP END------------------------------->
    <tr> 
