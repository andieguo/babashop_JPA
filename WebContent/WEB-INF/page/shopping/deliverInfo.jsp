...
<link href="<%=basePath%>/css/global/address.css" rel="stylesheet" type="text/css">
<link href="<%=basePath%>/css/global/bottom.css" rel="stylesheet" type="text/css">
<TITLE>巴巴运动网：结算中心：填写收货地址</TITLE>
<SCRIPT LANGUAGE="JavaScript" src="<%=basePath%>/js/Country.js" type="text/javascript"></SCRIPT>
<SCRIPT LANGUAGE="JavaScript" src="<%=basePath%>/js/provinceArea.js" type="text/javascript"></SCRIPT>
...
<TABLE cellSpacing=0 cellPadding=0 align="center" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="<%=basePath%>/images/global/logo.gif" >   &nbsp;&nbsp;<IMG height=36 src="<%=basePath%>/images/buy/az-s-checkout-shipping-bann.gif" > </TD></TR></TBODY></TABLE><BR>
...
<font color="#484848">（手机和电话至少有一项必填）</font></TD></TR>
        ...
        <TR>
          <TD colSpan=2 align="center"><IMG onClick="javascript:sendForm()" src="<%=basePath%>/images/buy/az-sfl-shipping-to-this-boo.gif" vspace=5 border=0 style="CURSOR: hand;"></TD></TR>
