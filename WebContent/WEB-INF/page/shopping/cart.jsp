...
<LINK href="<%=basePath%>/css/new_cart.css" rel="stylesheet" type="text/css">
...
<TABLE cellSpacing=0 cellPadding=5 width="98%" border="0" align="center">
  <TR>
    <TD><TABLE cellSpacing=0 cellPadding=0 width="96%" border=0>
      <TBODY>
        <TR>
          <TD width="24%"><IMG height=31 src="<%=basePath%>/images/buy/shop-cart-header-blue.gif" width="218" border=0></TD>
          <TD width="34%">如果您修改了商品数量，请点击 
             <img style="CURSOR: hand; " alt="修改数量" src="<%=basePath%>/images/buy/update-t-sm.gif" value="修改数量" border="0" onClick="javascript:modifyAmount()"></TD>
          <TD width="14%" align="left"><a href="<html:rewrite action="/shopping/cart/manage" />?method=deleteAll&directUrl=${param.directUrl}"><img style="CURSOR:hand;" alt="清空购物车" src="<%=basePath%>/images/buy/az-empty-shoppingcard.gif" border="0"></a></TD>
          <TD width="15%" align=left><a href="<%=basePath%>/"><img src="<%=basePath%>/images/buy/as-s-continus.gif" width="116" height="22" border="0"></a></TD>
          <TD width="13%" align=right><img style="CURSOR:hand;" src="<%=basePath%>/images/buy/az-by-split.gif" width="116" height="22" onClick="javascript:settleAccounts()"></TD>
        </TR>
      </TBODY>
    </TABLE></TD>
  </TR>
...
<c:forEach items="${buyCart.items}" var="item"> 
       <TR vAlign="top">
        ...
        <TD align="middle" width="66"><a href="<html:rewrite action="/shopping/cart/manage" />?method=delete&directUrl=${param.directUrl }&buyitemid=${item.product.id}-<c:forEach items="${item.product.styles}" var="style">${style.id}</c:forEach>"><img height="17" src="<%=basePath%>/images/buy/delete.gif" width="45" border="0"></a></TD>
      </TR>
      <TR vAlign="top">
        <TD colSpan="5"><IMG height=1 src="<%=basePath%>/images/buy/green-pixel.gif" width="100%" border="0"></TD>
      </TR>
</c:forEach>
<!-- loop end -->	  
    </TABLE></FORM>
      <table width="96%" border="0" align="left">
        ...
        <tr>
          ...
          <td colspan="2" align="right"><img style="CURSOR:hand;" src="<%=basePath%>/images/buy/az-by-split.gif" width="116" height="22" onClick="javascript:settleAccounts()"></td>
        </tr>
      </table></TD>
  </TR>
</TABLE>
