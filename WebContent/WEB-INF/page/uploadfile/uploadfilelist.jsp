...
<!--
	...
	function deleteFiles(objform){
		objform.action='<html:rewrite action="/control/uploadfile/manage"/>';//新的action
		objform.method.value="delete";//新的method
		objform.submit();//提交
	}
//-->
</script>
...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="<%=basePath %>${entry.filepath}" target="_blank">${entry.filepath}</a></div></td>
